...
exports.executeConversationsFromUser = exports.getAllConversationFromUser = void 0;
...
const getAllConversationFromUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const conversations = yield (0, exports.executeConversationsFromUser)(userId);
        res.status(200).json({
...
const executeConversationsFromUser = (userId) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.executeConversationsFromUser = executeConversationsFromUser;
