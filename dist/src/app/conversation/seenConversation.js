...
const seenConversation = (currentUsername, conversationId) =>
...
const execute = (currentUsername, conversationId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentUser = yield UserRepository_1.default.findByUsername(
      currentUsername
    );
    const conversation = yield ConversationRepository_1.default.findById(
      conversationId
    );
    (0, checkdata_1.checkThatUserExistsOrThrow)(currentUser);
    (0, checkdata_1.checkThatConversationExist)(conversation);
    yield ConversationRepository_1.default.updateConversationOnSeen(
      conversation,
      currentUser
    );
