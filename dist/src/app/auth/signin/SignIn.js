...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(200).json({ code: util_1.successCode, message: "Connexion avec succès", payload: (0, UserResponse_1.userToUserResponse)(user), token: (0, tokenManagement_1.generateAccessToken)(user) });
    }
    catch (err) {
