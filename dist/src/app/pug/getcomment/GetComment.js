...
const getComments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(200).json({ code: util_1.successCode, message: "Liste des commentaires", payload: result });
    }
    catch (err) {
...
const execute = (userId, pugId, pugName) => __awaiter(void 0, void 0, void 0, function* () {
