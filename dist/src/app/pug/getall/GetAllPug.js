...
const getAllPugs = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const token = ((_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1]) || "";
        const { userId } = (0, tokenManagement_1.decodeToken)(token);
        const result = yield execute(userId);
        res.status(200).json({ code: util_1.successCode, message: "Pugs Utilisateur", payload: result });
    }
    catch (err) {
...
const execute = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result)
        return { username: currentUser.username, pugs: [] };
    return (0, UserPugResponse_1.userPugToResponse)(result, currentUser.username);
});
