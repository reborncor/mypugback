...
const signalPug = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const token = ((_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1]) || "";
        const { userId } = (0, tokenManagement_1.decodeToken)(token);
        const { username, reason, pugId } = req.body;
        const user = yield execute(userId, username, reason, pugId);
        res
            .status(200)
...
exports.signalPug = signalPug;
const execute = (userId, username, reason, pugId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield SignalPugRepository_1.default.insert(signal);
