...
exports.unLikePug = unLikePug;
const execute = (userId, pugId, username) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const test = yield PugRepository_1.default.findUserInPugLike(
      currentUser.username,
      pug,
      username
    );
    (0, checkdata_1.checkThatUserHasLiked)(test);
    const result = yield PugRepository_1.default.unLikePug(
      currentUser,
      pug,
      username
    );
