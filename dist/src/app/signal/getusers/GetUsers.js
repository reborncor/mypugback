...
exports.getAllUsersSignal = void 0;
...
const getAllUsersSignal = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
...
exports.getAllUsersSignal = getAllUsersSignal;
const execute = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield SignalRepository_1.default.findAll();
