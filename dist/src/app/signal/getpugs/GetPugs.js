...
exports.getAllPugsSignal = void 0;
...
const getAllPugsSignal = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
...
exports.getAllPugsSignal = getAllPugsSignal;
const execute = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield SignalPugRepository_1.default.findAll();
