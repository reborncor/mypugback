...
const getPugSignal = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
...
exports.getPugSignal = getPugSignal;
const execute = (userId, pugId, username) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield SignalPugRepository_1.default.findByPugId(pugId, username);
    return (0, SignalPugResponse_1.signalPugResponse)(result);
});
