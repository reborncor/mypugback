...
exports.pugToResponsePageableSorted =
  exports.pugToResponsePageable =
  exports.pugToResponseNoComment =
  exports.pugToResponse =
    void 0;
...
function pugToResponsePageableSorted(pug, username, author) {
  let isLiked = false;
  pug.usersLike.forEach((value) => {
    if (value == username) {
      isLiked = true;
