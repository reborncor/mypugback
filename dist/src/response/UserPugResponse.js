...
function userPugToResponse(userPug, username) {
    const pugsResponse = [];
    userPug.pugs.forEach((value) => pugsResponse.push((0, PugResponse_1.pugToResponse)(value, username, userPug)));
    return {
        pugs: pugsResponse,
...
function userPugToResponseNoComment(userPug, currentUser, otherUser) {
    ...
    userPug.forEach((value) => {
        var _a;
        return pugsResponse.push((0, PugResponse_1.pugToResponseNoComment)(value.pug, currentUser, {
            _id: new bson_1.ObjectId(value.userId),
            username: value._id,
            profilePicture: (_a = value.prorilePicture) !== null && _a !== void 0 ? _a : "",
