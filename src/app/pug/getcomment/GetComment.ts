...
export const getComments = async  (req : Request, res : Response) =>{
    ...
    try{
        ...
        res.status(200).json({code : successCode, message :"Liste des commentaires", payload : result});
    }catch (err : any){
...
const execute = async (userId: string, pugId :string, pugName : string): Promise<any> => {
